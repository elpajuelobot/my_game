...
stand_right_villain = [transform.scale(image.load(f'assets/img/players/villian/NightBorne_Idle_{i}.png'), (config.width_enemy, config.height_enemy)) for i in range(0, 8)]
dead_right_villain = [transform.scale(image.load(f'assets/img/players/villian/NightBorne_Death_{i}.png'), (config.width_enemy, config.height_enemy)) for i in range(0, 22)]
run_right_villain = [transform.scale(image.load(f'assets/img/players/villian/NightBorne_Run_{i}.png'), (config.width_enemy, config.height_enemy)) for i in range(0, 5)]
run_left_villain = [transform.scale(image.load(f'assets/img/players/villian/NightBorne_RunL_{i}.png'), (config.width_enemy, config.height_enemy)) for i in range(0, 5)]
attack_right_villain = [transform.scale(image.load(f'assets/img/players/villian/NightBorne_Attack_{i}.png') ,(config.width_enemy, config.height_enemy)) for i in range(0, 11)]

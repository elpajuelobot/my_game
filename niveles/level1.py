...
def level1():
    ...
    while not level_complete:
        ...
        while internal_game:
            ...
            if pausa:
                fuente = font.SysFont("Arial", 50)
                texto_pausa = fuente.render("PAUSA", True, (255, 255, 255))
                wn.blit(texto_pausa, (config.WIDHT // 2 - texto_pausa.get_width() // 2, config.HEIGHT // 2))
                display.update()
                continue
            ...
            elif enemy.is_dead and not enemy.visible and hero.health == 0:
                player_won = None
